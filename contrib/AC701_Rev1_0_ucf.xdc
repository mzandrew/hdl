...
create_clock -add -name sysclk_p -period 5.0 -waveform {0 2.5} [get_ports { SYSCLK_P }];

# 200 MHz sysclk: pdf page 3, 8
set_property PACKAGE_PIN R3 [get_ports SYSCLK_P]; # 200 MHz

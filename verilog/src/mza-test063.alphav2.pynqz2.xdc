...
##Switches
set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS33 PULLDOWN TRUE } [get_ports { sw[0] }]; #IO_L7N_T1_AD2N_35 Sch=sw[0]
set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 PULLDOWN TRUE } [get_ports { sw[1] }]; #IO_L7P_T1_AD2P_35 Sch=sw[1]

##RGB LEDs
#set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 DRIVE 4 } [get_ports { led4_b }]; #IO_L22N_T3_AD7N_35 Sch=led4_b
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 DRIVE 4 } [get_ports { led4_g }]; #IO_L16P_T2_35 Sch=led4_g
#set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 DRIVE 4 } [get_ports { led4_r }]; #IO_L21P_T3_DQS_AD14P_35 Sch=led4_r
#set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 DRIVE 4 } [get_ports { led5_b }]; #IO_0_35 Sch=led5_b
#set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 DRIVE 4 } [get_ports { led5_g }]; #IO_L22P_T3_AD7P_35 Sch=led5_g
#set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 DRIVE 4 } [get_ports { led5_r }]; #IO_L23N_T3_35 Sch=led5_r

##LEDs
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 } [get_ports { led[0] }]; #IO_L6N_T0_VREF_34 Sch=led[0]
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 } [get_ports { led[1] }]; #IO_L6P_T0_34 Sch=led[1]
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 } [get_ports { led[2] }]; #IO_L21N_T3_DQS_AD14N_35 Sch=led[2]
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 } [get_ports { led[3] }]; #IO_L23P_T3_35 Sch=led[3]
...
set_property -dict { PACKAGE_PIN U19   IOSTANDARD TMDS_33  } [get_ports { ja[5] }]; #IO_L12N_T1_MRCC_34 Sch=ja_n[3] pmodA_pin8 clock_pmod_pin2
#set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { ja[6] }]; #IO_L22P_T3_34 Sch=ja_p[4] pmodA_pin9 clock_pmod_pin4
...
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 PULLDOWN TRUE } [get_ports { debug[0] }]; #IO_L4P_T0_34 Sch=jb_p[4]
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 PULLDOWN TRUE } [get_ports { debug[1] }]; #IO_L4N_T0_34 Sch=jb_n[4]
...
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 } [get_ports { rpio_06_r }]; #IO_L22P_T3_13 Sch=rpio_06_r
#set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 } [get_ports { rpio_07_r }]; #IO_L12P_T1_MRCC_34 Sch=rpio_07_r
#set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 } [get_ports { rpio_08_r }]; #IO_L12N_T1_MRCC_34 Sch=rpio_08_r
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 } [get_ports { rpio_09_r }]; #IO_L21N_T3_DQS_13 Sch=rpio_09_r
...
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 PULLUP TRUE } [get_ports { rpio_13_r }]; #IO_L15N_T2_DQS_13 Sch=rpio_13_r sda
...
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 } [get_ports { rpio_17_r }]; #IO_L11P_T1_SRCC_13 Sch=rpio_17_r
set_property -dict { PACKAGE_PIN C20   IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 } [get_ports { rpio_18_r }]; #IO_L1P_T0_AD0P_35 Sch=rpio_18_r
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 PULLUP TRUE } [get_ports { rpio_19_r }]; #IO_L14N_T2_SRCC_13 Sch=rpio_19_r scl
#set_property -dict { PACKAGE_PIN A20   IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 } [get_ports { rpio_20_r }]; #IO_L2N_T0_AD8N_35 Sch=rpio_20_r
#set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 } [get_ports { rpio_21_r }]; #IO_L14P_T2_SRCC_13 Sch=rpio_21_r
#set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 } [get_ports { rpio_22_r }]; #IO_L17N_T2_13 Sch=rpio_22_r
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4 } [get_ports { rpio_23_r }]; #IO_IO_L22N_T3_13 Sch=rpio_23_r
...
#set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { hdmi_rx_clk_p }]; #IO_L13P_T2_MRCC_34 Sch=hdmi_rx_clk_p
#set_property -dict { PACKAGE_PIN W20   IOSTANDARD TMDS_33 } [get_ports { hdmi_rx_d0_n }]; #IO_L16N_T2_34 Sch=hdmi_rx_d_n[0]
#set_property -dict { PACKAGE_PIN V20   IOSTANDARD TMDS_33 } [get_ports { hdmi_rx_d0_p }]; #IO_L16P_T2_34 Sch=hdmi_rx_d_p[0]
...
set_property -dict { PACKAGE_PIN N20   IOSTANDARD TMDS_33 } [get_ports { hdmi_rx_d2_p }]; #IO_L14P_T2_SRCC_34 Sch=hdmi_rx_d_p[2]

...
#set_property -dict { PACKAGE_PIN W20   IOSTANDARD TMDS_33 } [get_ports { hdmi_rx_d_n }]; #IO_L16N_T2_34 Sch=hdmi_rx_d_n[0]
#set_property -dict { PACKAGE_PIN V20   IOSTANDARD TMDS_33 } [get_ports { hdmi_rx_d_p }]; #IO_L16P_T2_34 Sch=hdmi_rx_d_p[0]
